...
Este módulo es un microservicio desarrollado con NestJS que utiliza comunicación TCP para la gestión del personal del hospital, permitiendo operaciones como alta, consulta, actualización y baja de registros de personal.
...
Este microservicio administra y expone operaciones para la gestión del personal del hospital mediante comunicación TCP, permitiendo su integración con otros módulos del sistema y facilitando el acceso seguro a la información del personal.
